/*Provided by Dr. Baarsch to test the events*/
...
public class EventTester {
    ...
    static Deadline midDeadline = new Deadline("Mid Deadline", deadline.minusDays(5));
    static Deadline firstDeadline = new Deadline("First Deadline", deadline.minusDays(10));
